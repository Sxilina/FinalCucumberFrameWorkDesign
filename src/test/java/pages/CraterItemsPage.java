...
public class CraterItemsPage {
	...
	//edit items
	@FindBy(xpath = "//a[contains(text(),'')]//parent::td//following-sibling::td[4]//button")
	public WebElement moreButton;
	
	@FindBy(xpath = "//a[contains(@id,'headlessui-menu-item')][1]") ////a[@role='menuitem']
	public WebElement editButton;
	
	// delete item page
	
	@FindBy(xpath = "//a[@role='menuitem']/parent::a/following-sibling::a")
	public WebElement deleteButton;
	
	@FindBy(xpath = "//p[contains(text(),'You will not be able to recover')]")
	public WebElement modalMessage;
	
	@FindBy(xpath = "//div[contains(@class,'inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom')]")
	...
	@FindBy(xpath = "//a[contains(text(),'')]//parent::td/a")
	public WebElement firstNameItemsTable;
